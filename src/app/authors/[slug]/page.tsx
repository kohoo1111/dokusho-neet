...
export default async function Page({params}:{params:Promise<{slug:string}>}) {
  ...
  const works=books.map(book=>({id:book.id,title:book.title,image:book.coverImage??coverUrl(book),isbn:book.isbn,isbn10:book.isbn10,rakutenUrl:book.rakutenUrl}));
