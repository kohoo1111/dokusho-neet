...
export function Footer() {
  return <footer className="mt-24 border-t border-black/[.08] bg-[#f7f7f7] text-[#555]">
    <div className="mx-auto grid max-w-[1280px] gap-10 px-5 py-14 md:grid-cols-[1fr_auto] md:px-10">
      ...
      {/* アフィリエイト参加の明示。Amazonアソシエイト・楽天アフィリエイトのいずれも規約で掲示を求めている。 */}
      <p className="max-w-2xl text-xs leading-6 text-[#8a847e] md:col-span-2">当サイトは、Amazon.co.jpを含むAmazonアソシエイト・プログラム、および楽天アフィリエイトの参加者です。これらのプログラムにより、各サイトへのリンクによって紹介料を得ることがあります。</p>
